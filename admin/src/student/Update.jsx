    ...
    return(
        ...
        <Form className="form">
           <FormField>
            ...
            <label className="me-3">Student Name</label>
           ...
           <FormField>
            ...
            <input value = {className} onChange={(e)=>setClassName(e.target.value)}placeholder="Enter Class Name" className="ms-3"/> 
           </FormField> <br />
           <FormField>
            <label className="me-1">Teacher Name</label>
            <input value = {teacherName} onChange={(e)=>setTeacherName(e.target.value)}placeholder="Enter Teacher Name" className="ms-3"/> 
           </FormField> <br />
           <FormField>
            <label className="me-1">Teacher Mobile</label>
            <input value = {teacherMobile} onChange={(e)=>setTeacherMobile(e.target.value)}placeholder="Enter Teacher Mobile" className="ms-3"/> 
           </FormField> <br />
          
           <Button className = "btn btn-warning" onClick={updateAdmin}> <span className = "fa-xl"><FontAwesomeIcon icon= {faPenSquare} /> </span>Update</Button> 
        </Form>
        </>
    )
}